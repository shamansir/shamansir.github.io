...
<has-children>
    <bind tag="icon">
        <tree:open>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="${iconSize} inline text-gray-700"
                fill="currentColor">
            ...
            <else />
            <svg xmlns="http://www.w3.org/2000/svg" class="${iconSize} inline text-gray-500" viewBox="0 0 24 24"
                fill="currentColor">
                <path fill-rule="evenodd"
