...
- <span class="section-num">2</span> [Versions](#versions)
- <span class="section-num">3</span> [Installing required software](#installing-required-software)
- <span class="section-num">4</span> [Preparation](#preparation)
- <span class="section-num">5</span> [Compilation](#compilation)
- <span class="section-num">6</span> [Possible drawbacks](#possible-drawbacks)
- <span class="section-num">7</span> [Tuning up Vim for Python](#tuning-up-vim-for-python)
