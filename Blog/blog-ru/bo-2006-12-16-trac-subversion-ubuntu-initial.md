...
> **Upd.**: Более структурированное и последовательное (правда менее повествовательное) руководство для [Ubuntu Feisty](<http://ubuntuguide.org/wiki/Ubuntu:Feisty> Ubuntu 7.04) находится [здесь](./bd-2008-03-17-trac-subversion-ubuntu-revisited.md)
