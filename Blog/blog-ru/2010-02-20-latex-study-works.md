...
![Титульная страница](../assets/ru/latex-study-works/latex_habr_titlepage.png)
...
![Сохранение в PDF](../assets/ru/latex-study-works/latex_habr_graph01_save.png)
...
![Опции экспорта в PDF](../assets/ru/latex-study-works/latex_habr_graph01_pdf.png)
...
![SVG-картинка в PDF](../assets/ru/latex-study-works/latex_habr_graph01_inside.png)
...
![Сохранение gnumeric-таблицы](../assets/ru/latex-study-works/latex_habr_table01_save.png)
...
![Сохранение таблицы в CSV](../assets/ru/latex-study-works/latex_habr_table01_savecsv.png)
...
![Параметры экспорта для CSV](../assets/ru/latex-study-works/latex_habr_table01_export.png)
...
![Как выглядит таблица](../assets/ru/latex-study-works/latex_habr_table01_rendered.png)
...
![Как выглядит график](../assets/ru/latex-study-works/latex_habr_plot01_rendered.png)
