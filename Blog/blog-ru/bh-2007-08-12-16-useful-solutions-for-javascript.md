...
Полные примеры использования относительно велики, поэтому я их вынесу в [следующую статью](./bg-2007-08-19-javascript-oop.md) и проследую далее. Пару простых примеров вы можете наблюдать в пунктах _[2](#sol-2)_, _[5](#sol-5)_ и _[15](#sol-15)_.
