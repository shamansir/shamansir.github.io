...
The following class inherits `ElementWrapper` and allows to work with element as a fully-functional graphic object (using some functions from [previous article](./at-2007-08-12-16-useful-solutions-for-javascript.md): `getElmAttr`, `setElmAttr`, `findOffsetHeight`, `getPosition`, `getAlignedPosition`)

> As it is for some functions from [previous article](./at-2007-08-12-16-useful-solutions-for-javascript.md), the code is changed through times -- in this case it was parallelly simplified and growed in functionality:
