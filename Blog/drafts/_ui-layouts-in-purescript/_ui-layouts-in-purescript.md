...
- [Play: UI Layouts in PureScript](#play-ui-layouts-in-purescript)
...
![row-1-inverted](assets/row-1-inverted.jpg)
...
![noodle-svg-tree](assets/noodle-svg-tree.jpg)
...
![clay-ui-video-screen](assets/clay-ui-video-screen.png)
...
![row-2-inverted](assets/row-2-inverted.jpg)
...
![row-3-inverted](assets/row-3-inverted.jpg)
...
![row-4-inverted](assets/row-4-inverted.jpg)
...
![row-5-inverted](assets/row-5-inverted.jpg)
...
![noodle-node-example-full-screen-with-tree-root](assets/noodle-node-example-full-screen-with-tree-root.png)
...
![row-7-inverted](assets/row-7-inverted.jpg)
...
![row-8-inverted](assets/row-8-inverted.jpg)
...
![kanji-radicals](assets/kanji-radicals.png)
...
![uncode-ids-example](assets/uncode-ids-example.png)
...
![uncode-ids-logic-example](assets/uncode-ids-logic-example.png)
...
![kanji-all](assets/kanji-all.png)
...
![kanji-example](assets/kanji-example.png)
...
![row-9-inverted](assets/row-9-inverted.jpg)
...
![mahjong-table-inspiration](assets/mahjong-table-inspiration.png)
...
![mahjong-table-inspiration-2](assets/mahjong-table-inspiration-2.png)
...
![mahjong-example-full-screen-2](assets/mahjong-example-full-screen-2.png)
...
![row-11-inverted](assets/row-11-inverted.jpg)
...
![svg-tree-layout-example](assets/Screenshot%202026-01-11%20at%2003.10.05.png)
